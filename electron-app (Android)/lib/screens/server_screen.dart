                ...
                children: [
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const KickerLabel('Allow Remote Control'),
                        const SizedBox(height: 6),
                        Text(
                          _controlAllowed
                              ? 'Viewers can control this device'
                              : 'View-only — input is blocked',
                          style: TextStyle(
                            fontFamily: 'monospace',
                            fontSize: 12,
                  ...
                  Switch(
                    value: _controlAllowed,
                    activeThumbColor: theme.primary,
                    onChanged: (value) {
                      setState(() => _controlAllowed = value);
                      _server.controlAllowed = value; // takes effect on the
                      // next control-client handshake immediately — no
                      // restart needed, matching server.py's admin-port
                      // toggle behavior.
                    },
                  ),
                ],
